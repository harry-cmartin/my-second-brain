...
Para entender melhor,  um exemplo usando a Programação Estruturada para escrever um programa que guia o cozinheiro na preparação da sopa de cebola.
